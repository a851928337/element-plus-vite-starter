          ...
          <div class="part">
            ...
            <div class="content">
              ...
              <el-form-item label="成立时间">
                <el-date-picker v-model="form.establishmentDate" style="width: 100%;" type="date" placeholder="请选择成立时间" />
              </el-form-item>
              <el-form-item label="公司Logo">
                ...
                >
                  ...
                  <div
                    v-else
                    class="h-full w-full flex items-center justify-center border border-gray-300 rounded-md border-dashed p-8"
                  >
