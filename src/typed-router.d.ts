...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/generate-report/': RouteRecordInfo<'/generate-report/', '/generate-report', Record<never, never>, Record<never, never>>,
    ...
    '/user-manage/detail/[id]': RouteRecordInfo<'/user-manage/detail/[id]', '/user-manage/detail/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
  }
}
